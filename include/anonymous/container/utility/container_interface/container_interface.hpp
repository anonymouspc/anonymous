...
class container_interface
{
    ...
    public: // Member
        ...
        constexpr       int             adjacent_find       (       relation      <type,type> auto  ) const requires random_access_range<container>;
        constexpr       array<int>      adjacent_where      (                                       ) const requires random_access_range<container> and equalable<type>;
        constexpr       array<int>      adjacent_where      (       relation      <type,type> auto  ) const requires random_access_range<container>;
        constexpr       bool            all                 ( const equalable_to  <type>      auto& ) const requires forward_range      <container>;
        constexpr       bool            all                 (       predicate     <type>      auto  ) const requires forward_range      <container>;
        constexpr       bool            contains            ( const equalable_to  <type>      auto& ) const requires forward_range      <container>;
        constexpr       bool            contains            (       predicate     <type>      auto  ) const requires forward_range      <container>;
        constexpr       int             count               ( const equalable_to  <type>      auto& ) const requires forward_range      <container>;
        constexpr       int             count               (       predicate     <type>      auto  ) const requires forward_range      <container>;
        constexpr       bool            exist               ( const equalable_to  <type>      auto& ) const requires forward_range      <container>;
        constexpr       bool            exist               (       predicate     <type>      auto  ) const requires forward_range      <container>;
        constexpr       int             find                ( const equalable_to  <type>      auto& ) const requires random_access_range<container>;
        constexpr       int             find                (       predicate     <type>      auto  ) const requires random_access_range<container>;
        constexpr       bool            is_partitioned      (       predicate     <type>      auto  ) const requires forward_range      <container>;
        constexpr       bool            is_sorted           (                                       ) const requires forward_range      <container> and comparable<type>;
        constexpr       bool            is_sorted           (       relation      <type,type> auto  ) const requires forward_range      <container>;
        constexpr       reference       max                 (                                       )       requires forward_range      <container> and comparable<type>;
        constexpr       const_reference max                 (       relation      <type,type> auto  ) const requires forward_range      <container>;
        constexpr       reference       min                 (                                       )       requires forward_range      <container> and comparable<type>;
        constexpr       const_reference min                 (       relation      <type,type> auto  ) const requires forward_range      <container>;
        constexpr       container&      next_permutation    (                                       )       requires bidirectional_range<container> and comparable<type>;
        constexpr       container&      next_permutation    (       relation      <type,type> auto  )       requires bidirectional_range<container>;
        constexpr       bool            none                ( const equalable_to  <type>      auto& ) const requires forward_range      <container>;
        constexpr       bool            none                (       predicate     <type>      auto  ) const requires forward_range      <container>;
        constexpr       container&      partial_sort        ( int                                   )       requires random_access_range<container> and comparable<type>;
        constexpr       container&      partial_sort        ( int,  relation      <type,type> auto  )       requires random_access_range<container>;
        constexpr       container&      partition           (       predicate     <type>      auto  )       requires forward_range      <container>;
        constexpr       container&      prev_permutation    (                                       )       requires bidirectional_range<container> and comparable<type>;
        constexpr       container&      prev_permutation    (       relation      <type,type> auto  )       requires bidirectional_range<container>;
        constexpr       container&      remove              ( const equalable_to  <type>      auto& )       requires forward_range      <container>;
        constexpr       container&      remove              (       predicate     <type>      auto  )       requires forward_range      <container>;
        ...
        constexpr       int             right_adjacent_find (       relation      <type,type> auto  ) const requires random_access_range<container>;
        constexpr       int             right_find          ( const equalable_to  <type>      auto& ) const requires random_access_range<container>;
        constexpr       int             right_find          (       predicate     <type>      auto  ) const requires random_access_range<container>;
        constexpr       container&      rotate              ( int                                   )       requires forward_range      <container>;
        constexpr       container&      stable_partition    (       predicate     <type>      auto  )       requires bidirectional_range<container>;
        constexpr       container&      stable_sort         (                                       )       requires random_access_range<container> and comparable<type>;
        constexpr       container&      stable_sort         (       relation      <type,type> auto  )       requires random_access_range<container>;      
        constexpr       container&      sort                (                                       )       requires random_access_range<container> and comparable<type>;
        constexpr       container&      sort                (       relation      <type,type> auto  )       requires random_access_range<container>;
        constexpr       container&      unique              (                                       )       requires forward_range      <container> and equalable<type>;
        constexpr       container&      unique              (       relation      <type,type> auto  )       requires forward_range      <container>;
        constexpr       array<int>      where               ( const equalable_to  <type>      auto& ) const requires random_access_range<container>;
        constexpr       array<int>      where               (       predicate     <type>      auto  ) const requires random_access_range<container>;
    ...
    public: // Member
        ...
        constexpr       container&      replace             (       predicate     <type>      auto,   const convertible_to<type> auto& ) requires forward_range<container>;
};

// #include "container_interface.cpp": the .cpp file is included in "array/array.hpp" as the implemention depends on array<int>.