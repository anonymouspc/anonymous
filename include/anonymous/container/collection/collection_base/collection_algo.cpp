...
constexpr auto collection_algo<container,type,device>::begin ( )
{
    return static_cast<container&>(self).begin();
}

template < class container, class type, class device > 
constexpr auto collection_algo<container,type,device>::begin ( ) const
{
    return static_cast<const container&>(self).begin();
}

template < class container, class type, class device > 
constexpr auto collection_algo<container,type,device>::end ( )
{
    return static_cast<container&>(self).end();
}

template < class container, class type, class device > 
constexpr auto collection_algo<container,type,device>::end ( ) const
{
    return static_cast<const container&>(self).end();
}

template < class container, class type, class device > 
constexpr auto collection_algo<container,type,device>::size ( ) const
{
...
template < class container, class type, class device > 
constexpr container& collection_algo<container,type,device>::for_each ( invocable<reference> auto op )
{
...
template < class container, class type, class device > 
constexpr const container& collection_algo<container,type,device>::for_each ( invocable<const_reference> auto op ) const
{
    device::for_each(begin(), end(), op);
