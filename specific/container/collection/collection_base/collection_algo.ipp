...
template < class collection_type, class type, class compare, class device > 
constexpr bool collection_algo<collection_type,type,compare,device>::all ( predicate<type> auto pred ) const
{
    return device::all_of ( const_derive_of_self.begin(), const_derive_of_self.end(), pred );
}

template < class collection_type, class type, class compare, class device > 
constexpr int collection_algo<collection_type,type,compare,device>::count ( predicate<type> auto pred ) const
{
    return device::count_if ( const_derive_of_self.begin(), const_derive_of_self.end(), pred );
}

template < class collection_type, class type, class compare, class device > 
constexpr bool collection_algo<collection_type,type,compare,device>::exist ( predicate<type> auto pred ) const
{
    return device::any_of ( const_derive_of_self.begin(), const_derive_of_self.end(), pred );
}

template < class collection_type, class type, class compare, class device > 
constexpr bool collection_algo<collection_type,type,compare,device>::none ( predicate<type> auto pred ) const
{
    return device::none_of ( const_derive_of_self.begin(), const_derive_of_self.end(), pred );
}

template < class collection_type, class type, class compare, class device > 
constexpr collection_type& collection_algo<collection_type,type,compare,device>::each ( invocable<type&> auto op )
{
...
template < class collection_type, class type, class compare, class device > 
constexpr const collection_type& collection_algo<collection_type,type,compare,device>::each ( invocable<const type&> auto op ) const
{
...
template < class collection_type, class type, class compare, class device > 
constexpr auto collection_algo<collection_type,type,compare,device>::sum ( ) const
...
template < class collection_type, class type, class compare, class device > 
constexpr auto collection_algo<collection_type,type,compare,device>::sum ( invocable<type> auto op ) const
...
template < class collection_type, class type, class compare, class device > 
constexpr auto collection_algo<collection_type,type,compare,device>::product ( ) const
...
template < class collection_type, class type, class compare, class device > 
constexpr auto collection_algo<collection_type,type,compare,device>::product ( invocable<type> auto op ) const
