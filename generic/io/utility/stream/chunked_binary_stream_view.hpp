...
class chunked_binary_ostream_view
{
    ...
    public: // Interface
        constexpr chunked_binary_ostream_view ( std::from_range_t, std::ranges::input_range auto&& r, stream_type&, int )
...
{
    public:
        constexpr chunked_binary_ostream ( std::from_range_t, std::ranges::input_range auto&& r, auto /*std::reference_wrapper<stream_type>*/ s, int chunk_len )
