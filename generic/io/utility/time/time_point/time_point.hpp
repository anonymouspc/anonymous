    ...
    extends public tuple<int,int,int,int,int,int,int,int,int>
{
    ...
    public: // Conversion
        template < class clock_type > constexpr time_point ( std::chrono::time_point<clock_type> );
        template < class clock_type > constexpr operator     std::chrono::time_point<clock_type> ( ) const;
