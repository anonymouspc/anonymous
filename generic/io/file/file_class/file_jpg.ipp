...
inline file_jpg::file_jpg ( path pth )
{
    open(pth);
}

inline file_jpg& file_jpg::open ( path pth )
{
    // Open file.
...
inline file_jpg& file_jpg::close ( )
{
    // Close file.
...
inline int& file_jpg::depth ( )
{
    return image_depth;
}

inline const int& file_jpg::depth ( ) const
{
    return image_depth;
}
