...
boost::asio::io_context    io_context         = boost::asio::io_context(2);
...
class io_initializer_t
{
    private: // Instance
        static io_initializer_t io_initializer;
...
io_initializer_t io_initializer_t::io_initializer;