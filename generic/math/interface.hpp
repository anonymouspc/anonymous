...
namespace ap
{
    ...
    constexpr array_type auto  convolve       ( const array_type auto&  left, const array_type auto&  right ) requires ( ( number_type<left_value_type>   or complex_type<left_value_type>   ) and ( number_type<right_value_type> or complex_type<right_value_type> ) ) and ( left_dimension == 1 and right_dimension == 1 ) and same_as<left_device_type,right_device_type>;
    constexpr array_type auto  cross          ( const array_type auto&  left, const array_type auto&  right ) requires ( ( number_type<left_value_type>   or complex_type<left_value_type>   ) and ( number_type<right_value_type> or complex_type<right_value_type> ) ) and ( left_dimension == 1 and right_dimension == 1 ) and same_as<left_device_type,right_device_type>;
    constexpr            auto  dot            ( const array_type auto&  left, const array_type auto&  right ) requires ( ( number_type<left_value_type>   or complex_type<left_value_type>   ) and ( number_type<right_value_type> or complex_type<right_value_type> ) ) and ( left_dimension == 1 and right_dimension == 1 ) and same_as<left_device_type,right_device_type>;
    ...
    constexpr array_type auto  ifft           ( const array_type auto&  vector )                              requires   ( number_type<vector_value_type> or complex_type<vector_value_type> ) and                                                                           ( vector_dimension == 1 );
