...
constexpr void opencl::linalg::plus ( const auto left, const auto right, auto output )
{
    ...
    {
        if constexpr ( detail::is_strided_layout   <left_layout_type> or detail::is_strided_layout   <right_layout_type> or
                       detail::is_transposed_layout<left_layout_type> or detail::is_transposed_layout<right_layout_type> )
...
constexpr void opencl::linalg::left_scale ( const auto left, const auto right, auto output )
{
    ...
    {
        if constexpr ( detail::is_strided_layout<right_layout_type> or detail::is_transposed_layout<right_layout_type>  )
...
constexpr void opencl::linalg::right_scale ( const auto left, const auto right, auto output )
{
    ...
    {
        if constexpr ( detail::is_strided_layout<left_layout_type> or detail::is_transposed_layout<left_layout_type> )
