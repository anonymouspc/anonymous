#pragma once
    ...
    class opencl
    {
        ...
        public: // Execution
            static detail::opencl_stream_context execution_context;
        ...
        public: // Container
            template < class type, int len >                                                                                                                      class array;             // Override functions with boost::compute::command_queue.
            template < class type, class traits = std::char_traits<type>, class alloc = allocator<type> >                                                         class basic_string;      // Override functions with boost::compute::command_queue. Create data(). Create resize() and other resize-based functions.
         ...
         // template < class type, class hash = hash<type>, class equal = equal_to<type>,  class alloc = allocator<type> >                                        using unordered_set      = unsupported;
            template < class type, class alloc = allocator<type> >                                                                                                class vector;            // Override functions with boost::compute::command_queue.
