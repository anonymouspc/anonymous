#pragma once
    ...
    #include "third_party/opencl_queue_context.hpp"
    ...
    class opencl
    {
        ...
        public: // Execution
            static detail::opencl_queue_context execution_context;
    ...
    #define build_with_source_type(src)        build_with_source(std::regex_replace(#src, std::regex("type"), demangle(typeid(type))), boost::compute::system::default_context())
    #define build_with_source_type1_type2(src) build_with_source(std::regex_replace(std::regex_replace(#src, std::regex("type1"), demangle(typeid(type1))), std::regex("type2"), demangle(typeid(type2))), boost::compute::system::default_context())
    #include "detail/reference.hpp"
    ...
    detail::opencl_queue_context opencl::execution_context = detail::opencl_queue_context(boost::compute::system::default_device().max_work_group_size());
#else
    class opencl
    {
        public: // Available
