#pragma once
    ...
    #include "detail/opencl_device_ptr.hpp"
    #include "detail/opencl_buffer_iterator.hpp"
    ...
    class opencl
    {
        ...
        public: // Container
            ...
            template < class type, class traits = std::char_traits<type>, class alloc = allocator<type> >                                                         class basic_string;      // Create data(), resize() and other resize-based functions.
            template < class type, class traits = std::char_traits<type> >                                                                                        class basic_string_view; // Create the whole class.
