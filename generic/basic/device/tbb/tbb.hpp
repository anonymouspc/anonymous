#pragma once
    ...
    class tbb
    {
        ...
        public: // Container
            template < class type, int len >                                                                                                                      class array          { static_assert(false, "not supported on this device"); };
            template < class type, class traits = std::char_traits<type>, class alloc = allocator<type> >                                                         class basic_string   { static_assert(false, "not supported on this device"); };
      ...
      /*!*/ constexpr static decltype(auto) for_each                 ( auto&&... args ) { return ::tbb::parallel_for_each     (std::forward<decltype(args)>(args)...); }
      ...
      /*!*/ constexpr static decltype(auto) sort                     ( auto&&... args ) { return ::tbb::parallel_sort         (std::forward<decltype(args)>(args)...); }
